// Quick Think - v2-minimal Controller Application
...
class QuickThinkController {
  ...
  onJoined(payload) {
    ...
    this.elements.hostStatus.textContent = this.isHost ? 'Host' : 'Waiting for host';
  ...
  handlePhaseChange(payload) {
    switch (payload.phase) {
      ...
      case 'LOCKED':
        this.elements.submittedAnswer.textContent = this.elements.answerInput.value || '(none)';
